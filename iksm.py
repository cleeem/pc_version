...
def get_login_url(app_user_agent):
	...
	return f'https://accounts.nintendo.com/connect/1.0.0/authorize?{urllib.parse.urlencode(body)}', auth_code_verifier

def log_in(ver, auth_code_verifier, use_account_url):
